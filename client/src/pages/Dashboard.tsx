...
const Dashboard: React.FC = () => {
  ...
  return (
    <section className="flex">
      ...
      ?
      <div className="fixed w-screen h-screen flex justify-center items-center top-0 left-0 z-10 bg-black/80 cursor-not-allowed">
        <div role="status">
    <svg aria-hidden="true" className="w-8 h-8 text-gray-700 animate-spin fill-orange-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
